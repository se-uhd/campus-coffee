    ...
    fun securityFilterChain(
        ...
        http {
            authorizeHttpRequests {
                // TODO (Exercise 1): require authentication on write operations (POST/PUT/DELETE),
                //  keeping reads, registration (POST /users), and the Swagger / dev endpoints open. The
                //  starter leaves everything open so the app builds green with no auth enforced yet.
