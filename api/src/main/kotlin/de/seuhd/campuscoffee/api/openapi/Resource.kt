 ...
 */
enum class Resource(val singular: String, val plural: String) {
    NONE("", ""),
    USER("user", "users"),
    POS("POS", "POS"),
     ...
     */
    fun displayNameForOperation(operation: Operation): String =
        if (operation == Operation.GET_ALL) plural else singular
}
